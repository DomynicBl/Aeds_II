...
class MetodosDeOrdenacao{
    ...
    public static void ParcialSelection(ArrayList<Pokemon> pokedex, int k) {
        for (int i = 0; i < k; i++) { // Percorre a lista
			int menor = i;
...
public class Classe_Pokemon{
    ...
    public static void main(String[] args){
        ...
        MetodosDeOrdenacao.ParcialSelection(pokedex, k);
        ...
        try {
            ...
            File arquivoLog = new File("matricula_selecaoParcial.txt"); // Cria o arquivo de log
